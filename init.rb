...
Redmine::Plugin.register :redmine_tkgmap do
  ...
  author 'Shota.K'
  description 'Añadir latitud y longitud con Google Maps.(Redmine 2.3, 2,2...). Modificado para incluir errores'
  version '0.1'
  url 'https://github.com/guillermogross/redmine_tkgmap'
